...
mixin _$CartState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<BookModel> data, int count, double total)
        success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<BookModel> data, int count, double total)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<BookModel> data, int count, double total});
}
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(final List<BookModel> data, this.count, this.total)
      : _data = data;

  final List<BookModel> _data;
  @override
  List<BookModel> get data {
  ...
  @override
  String toString() {
    return 'CartState<$T>.success(data: $data, count: $count, total: $total)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_data), count, total);
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(data, count, total);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(data, count, total);
  }
...
abstract class Success<T> implements CartState<T> {
  const factory Success(
          final List<BookModel> data, final int count, final double total) =
      _$SuccessImpl<T>;
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CartState<$T>.error(errMessage: $errMessage)';
  }
