                      ...
                      builder: (context, state) {
                        return Positioned(
                            ...
                            left: SizeConfig.screenWidth/2.5,
                              ...
                              child: Row(children: [
                                    for(int i =0;i<3;i++)  TCircularContainer(width: 15,height: 4,margin: const EdgeInsets.only(right: 5),radius: 0,
                                    backgroundColor: BlocProvider.of<SliderCubit>(context).carouselCurrentIndex==i?secondaryColor:grey,
                                    )
                              ],),
                            );
                      },
