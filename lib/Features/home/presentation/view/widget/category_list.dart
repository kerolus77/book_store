          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      BlocProvider.of<CategoryListCubit>(context).setCategoryIndex(index);
                    ...
                    child: Container(
                      ...
                      decoration:  BoxDecoration(
                       // Optional: Add border
                      border: BlocProvider.of<CategoryListCubit>(context).categoryCurrentIndex== index? const Border(bottom: BorderSide(color: Colors.black,width: 2)):null,
                      
                      ),
                      child: Center(
                        child: Text(
                          categories[index],
                          style: subheadingStyle.copyWith(color: BlocProvider.of<CategoryListCubit>(context).categoryCurrentIndex== index?Colors.black:Colors.grey),
                        ),
                      ),
                    ),
                  ),
