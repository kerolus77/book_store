...
import '../../view_model/category_book_cubit/category_book_cubit.dart';
import '../../view_model/category_list_cubit/category_list_cubit.dart';

List<String> categories = ['All', 'Art', 'Psychology', 'Drama', 'Romance'];
